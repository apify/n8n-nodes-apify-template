...
import { ApifyRagWebBrowser, ClassNameCamel, PACKAGE_NAME } from '../../ApifyRagWebBrowser.node';
...
nodeTypes.addNode(`${PACKAGE_NAME}.${ClassNameCamel}`, new ApifyRagWebBrowser());
